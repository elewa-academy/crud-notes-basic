...
/* ------------------- READ -------------------*/
// GET  "/:id"             => View Note Info with id ...

/* ------------------- UPDATE -------------------*/
// GET  "/:id/update"     => update Note with id...
// POST "/:id/update"     => update Note with id...
//                                 Redirect to "/note/:id"

/* ------------------- DELETE -------------------*/
// GET  "/:id/delete"     => delete Note with id...
// POST "/:id/delete"     => delete Note with id...
//                                 Redirect to "/"
